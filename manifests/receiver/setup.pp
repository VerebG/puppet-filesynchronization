class filesynchronization::receiver::setup {
	...
	'RSYNC_SET_LISTEN_ADDRESS':
	    context => $::filesynchronization::rsyncd_daemon_conf_file,
	    changes => "set /files/etc/default/rsync/RSYNC_OPTS \"\'--address= ${::filesynchronization::rsyncd_ipv4_listen}\'\"",
	    onlyif  => "get /files/etc/default/rsync/RSYNC_OPTS != \"\'--address= ${::filesynchronization::rsyncd_ipv4_listen}\'\"";
	'RSYNC_SET_NICE':
	    context => $::filesynchronization::rsyncd_daemon_conf_file,
